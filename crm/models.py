...
class Customer(models.Model):
    '''客户信息表'''
    name = models.CharField(max_length=32, blank=True, null=True, verbose_name="名字", help_text="用户报名后请改为真实姓名")
    ...
    phone = models.CharField(max_length=64, blank=True, null=True, verbose_name="联系方式")
    id_num = models.CharField(max_length=64, blank=True, null=True, verbose_name="身份证号")
    email = models.EmailField(blank=True, null=True, verbose_name="常用邮箱")
    ...
    status = models.SmallIntegerField(choices=status_choices, default=1, verbose_name="客户状态")
...
class ClassList(models.Model):
    ...
    contract = models.ForeignKey("ContraTemplate", blank=True, null=True)
...
class ContraTemplate(models.Model):
    """合同模板"""
    name = models.CharField("合同名称",max_length=64,null=True)
